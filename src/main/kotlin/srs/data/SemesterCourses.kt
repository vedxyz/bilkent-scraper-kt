...
internal fun parseSemesterCourses(dom: Document): SemesterCourses {
...
internal suspend fun getCurrentSemesterCourses(cookie: String): SemesterCourses {
    val responseText = HttpUtils.guardedFetch("https://stars.bilkent.edu.tr/srs/ajax/courses.php", cookie)
    return parseSemesterCourses(Jsoup.parse(responseText))
}
